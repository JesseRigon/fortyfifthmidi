...
rc=0
for t in test-theory test-chordname test-layout test-binding test-progression test-diatonic test-octave test-keyboard test-highlight test-anchor test-legato; do
  printf '%-18s ' "$t"
